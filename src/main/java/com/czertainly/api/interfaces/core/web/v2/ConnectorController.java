...
public interface ConnectorController extends AuthProtectedController {
    ...
    @Operation(operationId = "getSearchableFieldsConnector", summary = "Get Connectors searchable fields information", operationId = "getConnectorSearchableFieldInformation")
